...
class Post extends React.Component {
  ...
  render() {
    ...
    const listPosts = list.map((lst) => {return <li key={lst.post}>{lst.post}</li>});/* TODO: convert this.state.posts into a list of <ListItem>. Remember to set the key and the post props */
